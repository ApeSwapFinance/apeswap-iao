...
module.exports = async function (deployer, network, accounts) {
  ...
  const deployments = [
    ...
    { // NOTE: For testing purposes
      stakingToken: '0x0000000000000000000000000000000000000000', // BNB
      offeringToken: '0x0000000000000000000000000000000000000000', // 
      startBlock: '100',
      endBlockOffset: '10',
      vestingBlockOffset: '10', //
      offeringAmount: ether('100'), // 
      raisingAmount: ether('.1'), // 
    },
  ]
  ...
  for (const deployment of deployments) {
    ...
    await deployer.deploy(IAOUpgradeProxy, proxyAdminAddress, IAOLinearVesting.address, abiEncodeData);
